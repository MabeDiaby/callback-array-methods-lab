...
// const minionHere = minions.forEach((a) =>console.log(a + " - here"))
...
//create a way to cap everyones name
	//use (0)
	//change that first letter into cap
// cap everyones except kevin
//push into new array
//every name in new array

const capMinion = minions.map(function(a){
	if (a !== "kevin"){
